...
class Manager extends Employee {
  ...
  fire(index) {
    this.report.forEach((employee) => {
      if (index === this.report.indexOf(employee)) {
        this.report.splice(index, 1);
      }
    });
  }
} //not sure why tests aren't working. console logs just fine
////////// PROBLEM 3 //////////
...
class ProgressiveManager extends Manager {
  ...
  hire() {
    const length = this.report.length;
    super.hire();
